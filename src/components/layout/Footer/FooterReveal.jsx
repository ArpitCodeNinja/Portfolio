    ...
    >
      <div className="fr-inner">
        <div className="fr-hero-zone">
          ...
          <div className="fr-hero-right">
            <p className="fr-hero-sub">
              Based in Gwalior, India — available for freelance, full-time &amp;
              collaborative work.
            </p>
            <a
              href="mailto:arpitsaxena856@gmail.com"
              className="fr-email-btn"
              aria-label="Email Arpit at arpitsaxena856@gmail.com"
              itemProp="email"
            >
              <span>arpitsaxena856@gmail.com</span>
              <RiArrowRightUpLine
        ...
        <div className="fr-columns">
          ...
          <div className="fr-col fr-col--about">
            ...
            <div className="fr-about-line fr-about-stack">
              {["Python", "Pandas", "MySQL", "numpy", "NLP", "Flask", "Scikit-learn", "Power BI", "Excel"].map((t) => (
            ...
            <div className="fr-about-line fr-contact-details">
              ...
              >
                <span itemProp="addressLocality">Gwalior</span>,{" "}
        ...
        <div className="fr-name-wrap" aria-hidden="true">
          <span className="fr-name">ARPIT </span>
        </div>
        ...
        <div className="fr-meta-bar">
          <span className="fr-copy">
            &copy; {year} Arpit Saxena. All rights reserved.
          </span>
          <span className="fr-craft">
            Crafted with GSAP &amp; React ·{" "}
            <a
              href="https://github.com/ArpitCodeNinja/Portfolio"
              target="_blank"
              rel="noopener noreferrer"
