...
const CONTACT_INFO = {
  ...
  phone: "+91 7470660098",
  email: "arpitsaxena856@gmail.com",
};
    ...
    <>
      ...
      >
        <div ref={menuContentRef} className="relative w-full h-full flex">
          <div className="absolute inset-0 w-full h-full overflow-hidden shrink-0 z-0 bg-neutral-950">
            <div
              ref={menuImageRef}
            ...
            >
              <img
                ...
                className="w-full h-full object-cover object-right opacity-40 pointer-events-none"
                loading="lazy"
              />
            </div>
          ...
          <div className="relative z-10 w-full md:w-[60%] lg:w-[50%] flex flex-col h-full overflow-y-auto p-6 sm:p-8 md:p-12 lg:p-16 mr-auto">
