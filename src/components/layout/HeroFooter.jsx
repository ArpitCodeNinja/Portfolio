...
const SOCIAL_LINKS = [
  {
    ...
    href: "https://www.linkedin.com/in/arpit21/",
    label: "LinkedIn",
  },
  {
    icon: RiGithubFill,
    href: "https://github.com/ArpitCodeNinja",
    label: "GitHub",
  },
  {
    icon: RiInstagramLine,
    href: "https://www.instagram.com/arpit8686/?hl=en",
    label: "Instagram",
  },
];
  ...
  useGSAP(
    () => {
      ...
      tlRef.current = gsap
        ...
        .to(
          [ctaRef.current, viewCvRef.current],
          {
            y: 0,
            autoAlpha: 1,
            scale: 1,
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 items-end gap-5 sm:gap-6 lg:gap-8">
        <div className="flex flex-col items-start gap-3 sm:gap-4">
          ...
          >
            Building data&nbsp;experiences that breathe
          </p>
          ...
          <div className="flex gap-4">
            ...
            <div
              ref={viewCvRef}
              className="group relative inline-flex items-center gap-2 border-2 border-white rounded-full px-4 py-2 sm:px-5 sm:py-2 lg:px-6 lg:py-2.5 text-sm sm:text-base lg:text-lg font-semibold tracking-widest text-white overflow-hidden transition-colors duration-500 whitespace-nowrap"
            >
              <span
                className="absolute inset-0 translate-y-full group-hover:translate-y-0 bg-white transition-transform duration-500 ease-[cubic-bezier(0.87,0,0.13,1)]"
                aria-hidden="true"
              ...
              <span className="relative z-10 flex items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="uppercase group-hover:text-black transition-colors duration-500 hover:text-white"
                >
                  View CV
                </a>
                <span className="w-px h-4 bg-white/30 group-hover:bg-black/30" />
                <a
                  href="/Specialized_CV_Arpit.pdf"
                  download="Specialized_CV_Arpit.pdf"
                  className="text-white group-hover:text-black hover:scale-110 transition-transform duration-300"
                  aria-label="Download CV"
                >
                  <RiDownloadLine className="w-5 h-5 sm:w-6 sm:h-6" />
                </a>
              </span>
            </div>
          </div>
