...
const SERVICES_TEXT =
  "I create data experiences that value clarity above complexity. Through clean analysis and precise storytelling, I aim to build work that reveals truth and offers a quiet sense of understanding.";
